...
class sys_mailer
{
     ...
     * Be aware that in PHP >= 5.6 this requires that the server's Certificate are valid.
     * @var boolean
     */
    ...
    /**
     * The optional S/MIME extra Certificate ("CA Chain") file path.
     * @var string
     * @access protected
     */
    protected $sign_extracers_file = '';
        ...
        if ($this->idnSupported() and
            ...
            if ($this->has8bitChars($domain) and @mb_check_encoding($domain, $this->CharSet)) {
                ...
                if (($punycode = defined('INTL_IDNA_VARIANT_UTS46') ?
                        idn_to_ascii($domain, $options, INTL_IDNA_VARIANT_UTS46) :
    ...
    public function createBody()
    {
        ...
        if ($this->isError()) {
            ...
            try {
                ...
                if (empty($this->sign_extracers_file)) {
                    $sign = @openssl_pkcs7_sign(
                        $file,
                        $signed,
                        'file://' . realpath($this->sign_cer_file),
     ...
     * @access public
     * @param string $cer_filename
     * @param string $key_filename
     * @param string $key_pass Password for private key
     * @param string $extracers_filename Optional path to chain Certificate
     */
    public function sign($cer_filename, $key_filename, $key_pass, $extracers_filename = '')
    {
        $this->sign_cer_file = $cer_filename;
        $this->sign_key_file = $key_filename;
        $this->sign_key_pass = $key_pass;
        $this->sign_extracers_file = $extracers_filename;
    }
