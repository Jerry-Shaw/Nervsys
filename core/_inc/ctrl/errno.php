...
class errno {
    ...
    /**
     * Load errno file from module
     * Storage the array content into $error_storage
     * The content of the errno file should be format to JSON
    ...
    /**
     * Get a standard errno result
     * Language pack needs to be loaded before getting an errno message
     *
     * @param int $code
     *
     * @return array
    ...
    /**
     * Get all the errors
     * Language pack needs to be loaded before getting errno messages
     *
     * @return array
     */
    public static function get_all(): array {
        $errors = [];
        $error_files = file::get_list(ROOT, '/_err/*.json', true);//Get all the json formatted errno files from all modules
    ...
    /**
     * Merge errno text with language
     *
     * @param array $errors
     * @param array $error
